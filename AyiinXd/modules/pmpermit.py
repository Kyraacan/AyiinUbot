...
@ayiin_cmd(outgoing=True, pattern=r"notifoff$")
...
@ayiin_cmd(outgoing=True, pattern=r"notifon$")
...
@ayiin_cmd(outgoing=True, pattern=r"unblock$")
...
@ayiin_cmd(outgoing=True, pattern=r"(set|get|reset) pmpermit(?: |$)(\w*)")
